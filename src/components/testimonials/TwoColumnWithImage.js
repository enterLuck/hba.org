...
export default () => {
  ...
  const testimonials = [
    {
      imageSrc:
        "https://www.tamvakislaw.com/assets/img/glt-port.jpg",
      quote:
        "The Law Firm of George L. Tamvakis is dedicated to protecting the rights of its clients and serving their legal needs.",
      customerName: "George L. Tamvakis",
      customerTitle: "Attorney at Law"
    },
    {
      imageSrc:
        "https://cdn.vox-cdn.com/thumbor/xtd2xDxXds_N9KCC1bYICVuwURE=/0x0:1200x630/1820x1213/filters:focal(504x219:696x411):format(webp)/cdn.vox-cdn.com/uploads/chorus_image/image/63548627/2019election_211_80982432_e1547951009299.0.jpg",
      quote:
        "Susan Sadlowski Garza is a lifelong Chicagoan and 10th Ward resident who has dedicated her entire life to the youth and families of the 10th Ward. ",
      customerName: "Susan Sadlowski",
      customerTitle: "10th Ward Alderwoman"
    },
    {
      imageSrc:
        "https://media.timeout.com/images/100903835/1372/772/image.jpg",
      quote:
        "Club 81 Too has been serving the Hegewisch Community for decades.",
      customerName: "Jim & Rose",
      customerTitle: "Owner"
    }
  ];
  return (
    <Container>
      <Content>
        <HeadingInfoContainer>
          <HeadingTitle>Our Awesome Sponsors</HeadingTitle>
